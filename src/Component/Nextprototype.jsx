        ...
        <div>
            <div className="logo-prototype">
                ...
                <div className="logo-t">
                    <span><a style={{color: "white", textDecoration:"none"}} href="https://www.figma.com/design/HYbd6m7tkKF0n7j2ssIyqS/PELLICCIS?node-id=0-1&t=fDr2H0vUlh3s8Q6O-1" target="_blank">{props.title} (click Here to view Figma LInk)</a></span>
                    <p>{props.subtitle}</p>
                </div>
            </div>
            <div>
